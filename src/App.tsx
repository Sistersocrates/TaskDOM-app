...
import PraiseLibraryPage from './pages/PraiseLibraryPage';
...
import { PraiseProvider } from './components/praise/PraiseProvider';
...
function App() {
  ...
  return (
    <HelmetProvider>
      <BrowserRouter>
        <PraiseProvider showNotifications={true} notificationPosition="top-right">
          <Routes>
            {/* Public routes */}
